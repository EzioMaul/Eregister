              ...
              <div class="col-lg">
                <div class="p-5">
                  <div class="text-center">
                    <img src="<?php echo base_url('assets/img/unnamed.png'); ?>" class="rounded" alt="logo">
                  </div>
                  <div class="text-center">
                  ...
                  <form action="<?php echo base_url('crud/tambah_aksi'); ?>" method="post">
                    ...
                    <div class="form-group">
                      <input type="text" class="form-control" id="no_tlp" name="no_tlp" placeholder="Nomor HP/Telephone">
                    </div>
                    <div class="form-group">
                      <div class="input-group mb-3">
                        <select class="custom-select" id="pekerjaan" name="pekerjaan" id="pekerjaan">
                          <option selected>Pekerjaan Anda</option>
                    ...
                    <div class="form-group">
                      <input type="text" class="form-control" id="lembaga" name="lembaga" placeholder="Instansi/Lembaga/Unit Kerja" id="instansi">
                    </div>
                    <div class="form-group">
                      <div class="input-group mb-3">
