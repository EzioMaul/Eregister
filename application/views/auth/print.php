...
<head>
    <!-- <title>Sukses!!!!!!!!!!</title> -->
    <title>Cetak Form Layanan Balittas</title>
...
<body onload="cetak()">
    <center>
        <div class="template">
            ...
            <h1 style="margin-top: -20px">Balai Penelitian Tanaman Pemanis dan Serat (Balittas)</h1>
            <h1 style="margin-top: -40px">_____________________________________________________</h1>
            <h1>Form Layanan Balittas</h1>
            <br><br>
            <table width="60%">
    ...
    <!-- <h3 align="center"><img src="images/l.gif" width="116" height="100"></h3>
<h3 align="center">Terima kasih atas kesediaan anda mengisi buku tamu</h3>
<h3 align="center">dan selamat menikmati layanan BALITTAS</h3>
<p align="center">&nbsp;</p>
<h3 align="center">Pengelola BALITTAS</h3> -->
</body>
